...
Vue.use(VueRouter)
  ...
  },
  {
    path: '/Evaluate',
    name: 'Evaluate',
    component: () => import('../views/Evaluate.vue') //评价
  },
  {
    path: '/Rate',
    name: 'Rate',
    component: () => import('../views/Rate.vue') //评价中心
  },
  {
    path: '/Comments',
    name: 'Comments',
    component: () => import('../views/Comments.vue') //查看评价
  },
  {
    path: '/myOrder',
    name: 'myOrder',
    component: () => import('../views/myOrder.vue') //全部订单
  },
  {
    path: '/Address',
    name: 'Address',
