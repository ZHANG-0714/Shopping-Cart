  ...
  <div class="home">
    <div class="search">
      ...
      <div class="city" @click="City">
        <div v-if="this.citys === null || this.Province.length < 0">
          <div v-if="city !== ''">
            {{city}}
            <span>▼</span>
          </div>
        ...
        <div v-if="this.Province.length < 0">
          <div v-if="city !== ''">
            {{city}}
            <span>▼</span>
          </div>
        ...
        <div v-else-if="this.Province.length < 0 ">
          <div>
            {{Province}}
            <span>▼</span>
          </div>
...
export default {
  ...
  mounted() {
    ...
    this.citys = localStorage.getItem("citys");

    this.Province = JSON.parse(localStorage.getItem("Province")).name;
