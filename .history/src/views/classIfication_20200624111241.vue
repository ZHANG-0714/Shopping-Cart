  ...
  methods: {
    ...
    modity(item){
      ...
      this.categoryitem = item;
       this.id = this.category.categoryitem.bxMallSubDto[0].mallSubId;
      //  console.log(this.id)
    ...
    label(arr){
      console.log(arr)
      // this.id = this.categoryitem.bxMallSubDto[arr].mallSubId;
       this.id = this.category.categoryitem.bxMallSubDto[name].mallSubId;
      console.log(this.id);
    }
  },
  mounted() {
