...
export default {
  ...
  methods: {
    ...
    buynow() {
      ...
      this.goodsOne.count = this.goodsOne.value;
      // this.$router.push({name: "Settlement",query: { item: this.goodOne }});
      // localStorage.setItem('items',JSON.stringify(this.goodOne))
      //  this.$router.push('Settlement')
      console.log(localStorage.setItem('items',JSON.stringify(this.goodOne)));
    }
  },
  mounted() {
    // 用户名
