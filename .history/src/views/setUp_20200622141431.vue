<template>
  ...
  <div>
    ...
    <!-- 用户名 -->
    <van-cell-group>
      <van-field v-model="value.nickname" label="用户名" placeholder="请输入用户名" />
    </van-cell-group>
    <!-- 昵称 -->
    <van-cell-group>
      <van-field v-model="value.username" label="昵称" />
    </van-cell-group>
    <!-- 性别 -->
    <van-cell-group>
      <van-field v-model="value.gender" label="性别" />
    </van-cell-group>
    <!-- 邮箱 -->
    <van-cell-group>
