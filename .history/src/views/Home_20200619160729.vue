<template>
  ...
  <div class="home">
    ...
    <div class="food">
      ...
      <Varieties :floorName='floorName1' :floor ='floor1'></Varieties>
    </div>
    <div class="food">
      <div class="first">2F</div>
      <Varieties :floorName='floorName2' :floor ='floor2'></Varieties>
    </div>
    <div class="food">
      <div class="first">3F</div>
      <Varieties :floorName='floorName3' :floor ='floor3'></Varieties>
    </div>
