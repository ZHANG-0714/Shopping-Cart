<template>
  ...
  <div>
    ...
    <!--      立即购买弹框-->
    <van-popup v-model="show" position="bottom" :style="{ height: '37%' }">
      <div class="popup">
        ...
        <div>
          ...
          <div class="presents">￥{{goodsOne.present_price}}</div>
        </div>
      </div>
      <!-- 购买数量 -->
      <div class="purchase">
      ...
      <!-- 立即购买 -->
      <van-button type="primary" block color="#ff4444">立即购买</van-button>
    </van-popup>
  </div> 
</template>
