<template>
  ...
  <div>
    ...
    <div class="select">
      <div class="orders">
        <van-padding-top: 31px; v-model="checked" shape="square" checked-color="#E0322B">全选</van-padding-top:>
      </div>
      <div class="order">
        <div>
          合计：
    ...
    <!-- 按钮 -->
    <div class="button">
      <van-button type="default" color="#ff7d44">删除</van-button>
      <van-button type="default" color="#ff7d44">去结算</van-button>
    </div>

    <!-- 购物车商品列表 -->
    <div class="arr">
      <div class="commodity" v-for="(item,index) in shopping" :key="index">
        <van-checkbox v-model="checkeds" shape="square" checked-color="#E0322B"></van-checkbox>
