<template>
  ...
  <div>
    ...
    <div class="freight">
      ...
      <div class="heart">
        <!-- 收藏 -->
        <div class="collection" @click="blocks" v-if="isCollection !==  1">
          <div>
            收藏:
        ...
        <!-- 取消收藏 -->
        <div class="collection" @click="block" v-else>
          <div>
            取消收藏:
  ...
  mounted() {
    ...
    this.$api
      ...
      .then(res => {
        ...
        // this.brows.push(this.goodOne);
        // localStorage.setItem("browse", JSON.stringify(this.brows));
      })
      .catch(err => {
        console.log(err);
      });
