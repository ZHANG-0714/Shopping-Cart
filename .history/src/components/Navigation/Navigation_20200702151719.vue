<template>
  <div class="van--tabbar--width">
    ...
    <van-tabbar v-model="active" active-color="red" route>
      ...
      <van-tabbar-item to="/shoppingCart" icon="shopping-cart" :badge='cartNum' v-if="this.user === null">购物车</van-tabbar-item>
      <van-tabbar-item to="/shoppingCart" icon="shopping-cart" :badge='cartNum' v-else>购物车</van-tabbar-item>
